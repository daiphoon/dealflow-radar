...
- 状态：产品方向已由负责人于 2026-09-13 明确；E4.1/E4.2 已合并部署，E4.3 原单公司已完成对照和初始导入；自动证据输出 0/1，真实增量及用户价值验收未通过，下一事项以看板为准。
...
2026-09-20 负责人再次确认：访问已有公司时，资料超过保鲜期即在已启用的预算、冷却、权限与去重规则下自动安排后台更新，手动申请是补充入口。普通未访问未关注公司不全量扫描；实现与完整交付约束见 [ADR-0023](ADR-0023-research-delivery-and-stale-refresh.md)。
