...
2026-09-22 E4.8 工程已合并部署，四家单次独立发现为 1/4，旧 3/9 保留；人工初始资料新增关联材料为 0，E4/EV14/M6B 不关闭。原 E4.9 建议已由负责人附件替代，当前按 [ADR-0025](DECISIONS/ADR-0025-matter-reliability-contract.md) 完成 A→B→C 本地可靠性改造；交付和边界见 [本地交付记录](16-matter-reliability-delivery.md)，不自动部署或复测。本轮样本以后属于回归，不再声称为新留出集。

E4.8 已部署版本的准入与回退以 ADR-0024 为准；本轮本地版本由 ADR-0025 补充历史/未知日期保留、0035 观测幂等及当前证据读取。原部署基线为：`matter-v1`/迁移 `0034`、专业获取和模型独立关闭、初始资料追加维护、未知日期不冒充近期事件。工程回归与下一次新样本价值验收分开记录，唯一状态仍看实施看板。
