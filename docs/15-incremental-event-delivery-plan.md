...
- 2026-09-15 合并部署及复测（已批准）：PR #87/#88 已合并部署，正常冷却后于当日 21:50 自动续作原公司一次；该次临时采用 12 HTTP，其余 4 搜索/2MB/180 秒/零模型/零金额及原身份、冻结查询、缓存和证据标准保持。长期默认上限不变，异常不重复派发；实际结果与停止点统一以有效看板为准。
